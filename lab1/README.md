...
Lab 1 is due at 11:59pm on Saturday, September 19th. All students are recommended to begin as soon as possible.

The first thing students should do is read through the [Lab 1 instructions](https://github.com/anqiwang02/stat-215-a-gsi/blob/main/lab1/instructions/lab1-instructions.pdf). Students should also make sure they are familiar with the [general lab instructions](https://github.com/anqiwang02/stat-215-a-gsi/blob/main/discussion/week1/lab-instructions.pdf). Between these two sets of instructions, there should be details covering:
- Setting up your `215a` environment, if you have not done so already.
...
Note that we have provided an [example lab report](https://github.com/anqiwang02/stat-215-a-gsi/blob/main/lab1/instructions/example_lab_report.pdf). This lab report is from a few years ago, and is for a different task and dataset. The idea is **NOT** to show you *exactly* what your lab report should look like, nor is it to show you what a perfect lab report looks like (this lab report may not get full credit). Instead, the idea is to show the type of formatting and attention to detail that we expect.

We recommend doing the following within the first week:
- Read the Kupperman et al. [paper](https://github.com/anqiwang02/stat-215-a-gsi/blob/main/lab1/documents/Kuppermann_2009_The-Lancet_000.pdf)
- Look through the [data documentation](https://github.com/anqiwang02/stat-215-a-gsi/blob/main/lab1/data/TBI%20PUD%20Documentation%2010-08-2013.xlsx)
